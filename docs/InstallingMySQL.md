...
Great work! :heart: To deepen your understanding of MySQL queries, schemas, data types, and tables, make sure to explore the following section [Select statements](./Task2Angus.md).
